...
; CHECK-GI-NEXT:    usubl v2.8h, v3.8b, v2.8b
...
; CHECK-GI-NEXT:    add x10, x10, x8
; CHECK-GI-NEXT:    add x11, x11, x9
; CHECK-GI-NEXT:    usubl v3.8h, v5.8b, v3.8b
...
; CHECK-GI-NEXT:    sshll v17.4s, v2.4h, #0
; CHECK-GI-NEXT:    sshll2 v2.4s, v2.8h, #0
; CHECK-GI-NEXT:    ldr d16, [x10]
; CHECK-GI-NEXT:    usubl v5.8h, v6.8b, v5.8b
...
; CHECK-GI-NEXT:    usubl v4.8h, v16.8b, v6.8b
; CHECK-GI-NEXT:    ldr d6, [x10]
...
; CHECK-GI-NEXT:    ldr d7, [x10, x8]
; CHECK-GI-NEXT:    ldr d19, [x11, x9]
; CHECK-GI-NEXT:    add v2.4s, v17.4s, v2.4s
; CHECK-GI-NEXT:    addv s1, v1.4s
...
; CHECK-GI-NEXT:    add v3.4s, v18.4s, v3.4s
; CHECK-GI-NEXT:    addv s2, v2.4s
; CHECK-GI-NEXT:    sshll v17.4s, v6.4h, #0
; CHECK-GI-NEXT:    sshll2 v6.4s, v6.8h, #0
; CHECK-GI-NEXT:    add v5.4s, v16.4s, v5.4s
; CHECK-GI-NEXT:    fmov w8, s1
; CHECK-GI-NEXT:    abs v16.4s, v19.4s
; CHECK-GI-NEXT:    abs v4.4s, v4.4s
; CHECK-GI-NEXT:    fmov w9, s0
...
; CHECK-GI-NEXT:    addv s2, v4.4s
; CHECK-GI-NEXT:    add w8, w9, w8
; CHECK-GI-NEXT:    fmov w9, s0
; CHECK-GI-NEXT:    add v3.4s, v18.4s, v7.4s
