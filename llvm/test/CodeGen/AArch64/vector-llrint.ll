...
; CHECK-NEXT:    mov h17, v0.h[2]
; CHECK-NEXT:    fcvt s18, h0
; CHECK-NEXT:    mov h21, v1.h[2]
; CHECK-NEXT:    mov h0, v0.h[3]
; CHECK-NEXT:    fcvt s19, h1
; CHECK-NEXT:    mov h20, v1.h[1]
...
; CHECK-NEXT:    frintx s5, s18
; CHECK-NEXT:    frintx s18, s19
; CHECK-NEXT:    frintx s16, s6
; CHECK-NEXT:    frintx s17, s2
; CHECK-NEXT:    fmov d6, x9
; CHECK-NEXT:    fmov d2, x8
; CHECK-NEXT:    fmov d7, x11
; CHECK-NEXT:    fcvtzs x8, s0
; CHECK-NEXT:    frintx s4, s4
; CHECK-NEXT:    frintx s19, s3
; CHECK-NEXT:    fmov d3, x10
; CHECK-NEXT:    fcvtzs x9, s5
; CHECK-NEXT:    fcvtzs x16, s18
; CHECK-NEXT:    fmov d0, x12
; CHECK-NEXT:    fcvtzs x10, s16
; CHECK-NEXT:    fcvtzs x11, s17
; CHECK-NEXT:    fmov d1, x14
; CHECK-NEXT:    fcvtzs x17, s4
; CHECK-NEXT:    fcvtzs x18, s19
...
; CHECK-NEXT:    mov h22, v0.h[1]
; CHECK-NEXT:    mov h24, v0.h[2]
; CHECK-NEXT:    fcvt s7, h4
; CHECK-NEXT:    mov h16, v5.h[2]
; CHECK-NEXT:    mov h17, v5.h[3]
; CHECK-NEXT:    fcvt s18, h5
; CHECK-NEXT:    mov h20, v6.h[1]
; CHECK-NEXT:    mov h23, v6.h[3]
; CHECK-NEXT:    mov h25, v19.h[1]
; CHECK-NEXT:    mov h21, v6.h[2]
; CHECK-NEXT:    fcvt s6, h6
; CHECK-NEXT:    mov h26, v19.h[2]
...
; CHECK-NEXT:    frintx s7, s16
; CHECK-NEXT:    frintx s16, s17
; CHECK-NEXT:    mov h17, v19.h[3]
; CHECK-NEXT:    fcvtzs x10, s18
; CHECK-NEXT:    fcvt s18, h19
; CHECK-NEXT:    fcvt s19, h25
; CHECK-NEXT:    frintx s20, s20
; CHECK-NEXT:    fcvt s25, h26
; CHECK-NEXT:    frintx s21, s21
; CHECK-NEXT:    fcvtzs x17, s6
; CHECK-NEXT:    frintx s6, s22
; CHECK-NEXT:    fcvtzs x16, s7
; CHECK-NEXT:    mov h7, v0.h[3]
; CHECK-NEXT:    fcvtzs x11, s16
; CHECK-NEXT:    frintx s16, s23
; CHECK-NEXT:    fcvt s17, h17
; CHECK-NEXT:    fcvt s0, h0
; CHECK-NEXT:    frintx s18, s18
; CHECK-NEXT:    frintx s19, s19
; CHECK-NEXT:    fcvtzs x12, s20
; CHECK-NEXT:    fcvt s20, h24
; CHECK-NEXT:    fcvtzs x18, s21
; CHECK-NEXT:    frintx s21, s25
; CHECK-NEXT:    fcvt s7, h7
; CHECK-NEXT:    fcvtzs x2, s6
; CHECK-NEXT:    fcvt s6, h1
; CHECK-NEXT:    fcvtzs x13, s16
; CHECK-NEXT:    frintx s16, s17
; CHECK-NEXT:    frintx s17, s0
; CHECK-NEXT:    fcvtzs x15, s18
; CHECK-NEXT:    fcvtzs x14, s19
; CHECK-NEXT:    mov h18, v1.h[1]
; CHECK-NEXT:    frintx s0, s20
; CHECK-NEXT:    mov h19, v1.h[2]
; CHECK-NEXT:    mov h20, v2.h[2]
; CHECK-NEXT:    frintx s7, s7
; CHECK-NEXT:    fcvtzs x1, s21
; CHECK-NEXT:    mov h21, v2.h[3]
; CHECK-NEXT:    fcvtzs x0, s16
; CHECK-NEXT:    fcvtzs x3, s17
; CHECK-NEXT:    mov h16, v3.h[2]
; CHECK-NEXT:    mov h17, v3.h[3]
; CHECK-NEXT:    mov h1, v1.h[3]
; CHECK-NEXT:    frintx s6, s6
; CHECK-NEXT:    fcvtzs x5, s0
; CHECK-NEXT:    fcvt s0, h18
; CHECK-NEXT:    fcvt s18, h19
; CHECK-NEXT:    fcvt s19, h20
; CHECK-NEXT:    fcvt s20, h3
; CHECK-NEXT:    mov h3, v3.h[1]
; CHECK-NEXT:    fcvtzs x4, s7
...
; CHECK-NEXT:    fcvt s1, h1
; CHECK-NEXT:    frintx s0, s0
; CHECK-NEXT:    fcvtzs x6, s6
; CHECK-NEXT:    fcvt s6, h21
; CHECK-NEXT:    fcvt s3, h3
; CHECK-NEXT:    frintx s19, s19
; CHECK-NEXT:    frintx s20, s20
; CHECK-NEXT:    fcvt s2, h2
...
; CHECK-NEXT:    frintx s1, s1
; CHECK-NEXT:    fcvtzs x7, s0
; CHECK-NEXT:    fmov d0, x16
; CHECK-NEXT:    frintx s6, s6
; CHECK-NEXT:    frintx s3, s3
; CHECK-NEXT:    fcvtzs x21, s19
; CHECK-NEXT:    fcvtzs x22, s20
; CHECK-NEXT:    frintx s2, s2
; CHECK-NEXT:    fcvtzs x20, s7
; CHECK-NEXT:    fmov d7, x17
; CHECK-NEXT:    fcvtzs x23, s16
; CHECK-NEXT:    fcvtzs x24, s17
; CHECK-NEXT:    fmov d16, x18
; CHECK-NEXT:    fmov d17, x1
; CHECK-NEXT:    fcvtzs x1, s1
; CHECK-NEXT:    mov h1, v4.h[1]
; CHECK-NEXT:    fcvtzs x16, s3
; CHECK-NEXT:    mov h3, v4.h[2]
; CHECK-NEXT:    fcvtzs x17, s6
; CHECK-NEXT:    fcvtzs x18, s2
; CHECK-NEXT:    mov h2, v4.h[3]
; CHECK-NEXT:    fmov d4, x20
; CHECK-NEXT:    fmov d21, x21
; CHECK-NEXT:    fmov d20, x22
; CHECK-NEXT:    fmov d6, x23
; CHECK-NEXT:    fcvt s1, h1
; CHECK-NEXT:    frintx s5, s5
; CHECK-NEXT:    fcvtzs x19, s18
; CHECK-NEXT:    fcvt s3, h3
; CHECK-NEXT:    mov v16.d[1], x13
; CHECK-NEXT:    mov v7.d[1], x12
; CHECK-NEXT:    fcvt s2, h2
; CHECK-NEXT:    mov v21.d[1], x17
; CHECK-NEXT:    mov v4.d[1], x18
; CHECK-NEXT:    mov v6.d[1], x24
; CHECK-NEXT:    mov v20.d[1], x16
; CHECK-NEXT:    fmov d18, x3
; CHECK-NEXT:    frintx s1, s1
; CHECK-NEXT:    fmov d19, x6
; CHECK-NEXT:    fmov d22, x19
; CHECK-NEXT:    stp q7, q16, [x8, #160]
; CHECK-NEXT:    frintx s3, s3
; CHECK-NEXT:    mov v17.d[1], x0
; CHECK-NEXT:    stp q4, q21, [x8, #128]
; CHECK-NEXT:    frintx s2, s2
; CHECK-NEXT:    fmov d4, x15
; CHECK-NEXT:    stp q20, q6, [x8, #192]
; CHECK-NEXT:    fmov d6, x5
; CHECK-NEXT:    mov v22.d[1], x1
; CHECK-NEXT:    fcvtzs x12, s1
; CHECK-NEXT:    fmov d1, x10
; CHECK-NEXT:    mov v19.d[1], x7
; CHECK-NEXT:    fcvtzs x15, s3
; CHECK-NEXT:    mov v4.d[1], x14
; CHECK-NEXT:    fcvtzs x14, s5
; CHECK-NEXT:    fcvtzs x13, s2
; CHECK-NEXT:    fmov d3, x9
; CHECK-NEXT:    mov v6.d[1], x4
; CHECK-NEXT:    mov v18.d[1], x2
; CHECK-NEXT:    mov v0.d[1], x11
; CHECK-NEXT:    stp q19, q22, [x8, #64]
; CHECK-NEXT:    stp q4, q17, [x8, #224]
; CHECK-NEXT:    fmov d2, x15
; CHECK-NEXT:    mov v1.d[1], x14
; CHECK-NEXT:    mov v3.d[1], x12
; CHECK-NEXT:    stp q18, q6, [x8]
; CHECK-NEXT:    mov v2.d[1], x13
; CHECK-NEXT:    stp q1, q0, [x8, #96]
