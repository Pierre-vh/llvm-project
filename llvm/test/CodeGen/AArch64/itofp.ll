...
; CHECK-SD-NEXT:    mov v7.s[1], w15
; CHECK-SD-NEXT:    umov w9, v0.b[5]
; CHECK-SD-NEXT:    fmov s19, w12
; CHECK-SD-NEXT:    umov w12, v3.b[6]
; CHECK-SD-NEXT:    mov v6.s[1], w14
...
; CHECK-SD-NEXT:    sshll v7.2d, v21.2s, #0
; CHECK-SD-NEXT:    fmov s21, w12
; CHECK-SD-NEXT:    umov w12, v3.b[7]
; CHECK-SD-NEXT:    sshr v3.2s, v17.2s, #24
; CHECK-SD-NEXT:    sshr v17.2s, v19.2s, #24
; CHECK-SD-NEXT:    fmov s19, w10
; CHECK-SD-NEXT:    umov w10, v0.b[1]
; CHECK-SD-NEXT:    sshr v18.2s, v18.2s, #24
; CHECK-SD-NEXT:    scvtf v6.2d, v6.2d
; CHECK-SD-NEXT:    mov v21.s[1], w9
; CHECK-SD-NEXT:    umov w9, v0.b[3]
; CHECK-SD-NEXT:    sshr v0.2s, v20.2s, #24
; CHECK-SD-NEXT:    fmov s20, w11
; CHECK-SD-NEXT:    umov w11, v2.b[4]
; CHECK-SD-NEXT:    shl v1.2s, v1.2s, #24
; CHECK-SD-NEXT:    mov v22.s[1], w12
; CHECK-SD-NEXT:    sshll v17.2d, v17.2s, #0
; CHECK-SD-NEXT:    umov w12, v2.b[3]
; CHECK-SD-NEXT:    mov v19.s[1], w10
; CHECK-SD-NEXT:    umov w10, v2.b[2]
; CHECK-SD-NEXT:    sshll v0.2d, v0.2s, #0
; CHECK-SD-NEXT:    shl v21.2s, v21.2s, #24
; CHECK-SD-NEXT:    mov v20.s[1], w9
; CHECK-SD-NEXT:    umov w9, v2.b[1]
; CHECK-SD-NEXT:    fmov s23, w11
; CHECK-SD-NEXT:    umov w11, v2.b[5]
; CHECK-SD-NEXT:    sshr v1.2s, v1.2s, #24
; CHECK-SD-NEXT:    sshll v2.2d, v18.2s, #0
; CHECK-SD-NEXT:    scvtf v0.2d, v0.2d
; CHECK-SD-NEXT:    scvtf v17.2d, v17.2d
; CHECK-SD-NEXT:    sshr v21.2s, v21.2s, #24
; CHECK-SD-NEXT:    shl v19.2s, v19.2s, #24
; CHECK-SD-NEXT:    sshll v3.2d, v3.2s, #0
; CHECK-SD-NEXT:    shl v18.2s, v20.2s, #24
; CHECK-SD-NEXT:    sshll v1.2d, v1.2s, #0
; CHECK-SD-NEXT:    mov v16.s[1], w9
; CHECK-SD-NEXT:    mov v23.s[1], w11
; CHECK-SD-NEXT:    scvtf v2.2d, v2.2d
; CHECK-SD-NEXT:    scvtf v5.2d, v5.2d
; CHECK-SD-NEXT:    stp q17, q0, [x8, #160]
; CHECK-SD-NEXT:    sshll v20.2d, v21.2s, #0
; CHECK-SD-NEXT:    shl v21.2s, v22.2s, #24
...
; CHECK-SD-NEXT:    mov v22.s[1], w12
; CHECK-SD-NEXT:    sshll v0.2d, v18.2s, #0
; CHECK-SD-NEXT:    sshll v18.2d, v19.2s, #0
; CHECK-SD-NEXT:    sshr v21.2s, v21.2s, #24
; CHECK-SD-NEXT:    scvtf v4.2d, v4.2d
; CHECK-SD-NEXT:    stp q3, q2, [x8, #32]
; CHECK-SD-NEXT:    sshr v2.2s, v16.2s, #24
; CHECK-SD-NEXT:    scvtf v3.2d, v7.2d
; CHECK-SD-NEXT:    stp q1, q20, [x8, #128]
; CHECK-SD-NEXT:    scvtf v0.2d, v0.2d
; CHECK-SD-NEXT:    sshr v1.2s, v17.2s, #24
; CHECK-SD-NEXT:    shl v19.2s, v22.2s, #24
; CHECK-SD-NEXT:    scvtf v17.2d, v18.2d
; CHECK-SD-NEXT:    sshll v21.2d, v21.2s, #0
; CHECK-SD-NEXT:    sshll v2.2d, v2.2s, #0
; CHECK-SD-NEXT:    sshll v1.2d, v1.2s, #0
; CHECK-SD-NEXT:    sshr v18.2s, v19.2s, #24
; CHECK-SD-NEXT:    scvtf v19.2d, v21.2d
; CHECK-SD-NEXT:    stp q17, q0, [x8]
; CHECK-SD-NEXT:    scvtf v2.2d, v2.2d
; CHECK-SD-NEXT:    scvtf v1.2d, v1.2d
; CHECK-SD-NEXT:    sshll v0.2d, v18.2s, #0
; CHECK-SD-NEXT:    stp q3, q19, [x8, #224]
; CHECK-SD-NEXT:    stp q1, q4, [x8, #96]
; CHECK-SD-NEXT:    scvtf v0.2d, v0.2d
; CHECK-SD-NEXT:    stp q2, q0, [x8, #64]
; CHECK-SD-NEXT:    ret
;
...
; CHECK-SD-NEXT:    ext v6.16b, v1.16b, v1.16b, #8
; CHECK-SD-NEXT:    umov w10, v0.b[0]
; CHECK-SD-NEXT:    umov w13, v0.b[2]
; CHECK-SD-NEXT:    umov w11, v1.b[5]
; CHECK-SD-NEXT:    movi d3, #0x0000ff000000ff
; CHECK-SD-NEXT:    umov w12, v2.b[6]
; CHECK-SD-NEXT:    fmov s19, w9
; CHECK-SD-NEXT:    umov w9, v1.b[0]
; CHECK-SD-NEXT:    fmov s4, w10
; CHECK-SD-NEXT:    umov w10, v6.b[0]
; CHECK-SD-NEXT:    fmov s17, w13
; CHECK-SD-NEXT:    umov w13, v6.b[6]
; CHECK-SD-NEXT:    umov w14, v2.b[7]
; CHECK-SD-NEXT:    mov v19.s[1], w11
; CHECK-SD-NEXT:    umov w11, v1.b[6]
; CHECK-SD-NEXT:    fmov s16, w12
; CHECK-SD-NEXT:    umov w12, v6.b[1]
; CHECK-SD-NEXT:    fmov s20, w9
; CHECK-SD-NEXT:    umov w9, v6.b[7]
; CHECK-SD-NEXT:    fmov s21, w10
; CHECK-SD-NEXT:    umov w10, v2.b[2]
; CHECK-SD-NEXT:    fmov s23, w13
; CHECK-SD-NEXT:    umov w13, v6.b[2]
; CHECK-SD-NEXT:    fmov s22, w11
; CHECK-SD-NEXT:    umov w11, v2.b[4]
; CHECK-SD-NEXT:    mov v16.s[1], w14
...
; CHECK-SD-NEXT:    umov w10, v1.b[1]
; CHECK-SD-NEXT:    fmov s24, w13
; CHECK-SD-NEXT:    umov w13, v1.b[3]
; CHECK-SD-NEXT:    fmov s18, w11
; CHECK-SD-NEXT:    umov w11, v1.b[2]
; CHECK-SD-NEXT:    and v16.8b, v16.8b, v3.8b
; CHECK-SD-NEXT:    and v21.8b, v21.8b, v3.8b
; CHECK-SD-NEXT:    fmov s5, w14
; CHECK-SD-NEXT:    umov w14, v2.b[3]
; CHECK-SD-NEXT:    and v23.8b, v23.8b, v3.8b
; CHECK-SD-NEXT:    mov v22.s[1], w9
; CHECK-SD-NEXT:    umov w9, v0.b[5]
; CHECK-SD-NEXT:    mov v20.s[1], w10
; CHECK-SD-NEXT:    umov w10, v0.b[6]
; CHECK-SD-NEXT:    ushll v1.2d, v16.2s, #0
; CHECK-SD-NEXT:    ushll v16.2d, v21.2s, #0
; CHECK-SD-NEXT:    fmov s25, w12
; CHECK-SD-NEXT:    umov w12, v0.b[3]
; CHECK-SD-NEXT:    ushll v21.2d, v23.2s, #0
; CHECK-SD-NEXT:    fmov s23, w11
; CHECK-SD-NEXT:    umov w11, v0.b[7]
; CHECK-SD-NEXT:    mov v7.s[1], w14
; CHECK-SD-NEXT:    umov w14, v6.b[4]
; CHECK-SD-NEXT:    and v19.8b, v19.8b, v3.8b
; CHECK-SD-NEXT:    mov v25.s[1], w9
; CHECK-SD-NEXT:    umov w9, v6.b[3]
; CHECK-SD-NEXT:    and v20.8b, v20.8b, v3.8b
; CHECK-SD-NEXT:    mov v23.s[1], w13
; CHECK-SD-NEXT:    umov w13, v0.b[1]
; CHECK-SD-NEXT:    and v0.8b, v22.8b, v3.8b
; CHECK-SD-NEXT:    fmov s22, w10
; CHECK-SD-NEXT:    umov w10, v6.b[5]
; CHECK-SD-NEXT:    ushll v19.2d, v19.2s, #0
; CHECK-SD-NEXT:    mov v17.s[1], w12
; CHECK-SD-NEXT:    ushll v20.2d, v20.2s, #0
; CHECK-SD-NEXT:    and v7.8b, v7.8b, v3.8b
; CHECK-SD-NEXT:    ushll v0.2d, v0.2s, #0
; CHECK-SD-NEXT:    and v25.8b, v25.8b, v3.8b
; CHECK-SD-NEXT:    mov v24.s[1], w9
; CHECK-SD-NEXT:    mov v22.s[1], w11
; CHECK-SD-NEXT:    and v6.8b, v23.8b, v3.8b
; CHECK-SD-NEXT:    fmov s23, w14
; CHECK-SD-NEXT:    mov v4.s[1], w13
; CHECK-SD-NEXT:    umov w11, v2.b[5]
; CHECK-SD-NEXT:    ucvtf v19.2d, v19.2d
; CHECK-SD-NEXT:    ucvtf v0.2d, v0.2d
...
; CHECK-SD-NEXT:    ushll v6.2d, v6.2s, #0
; CHECK-SD-NEXT:    mov v23.s[1], w10
; CHECK-SD-NEXT:    and v17.8b, v17.8b, v3.8b
; CHECK-SD-NEXT:    and v22.8b, v22.8b, v3.8b
; CHECK-SD-NEXT:    ucvtf v20.2d, v20.2d
; CHECK-SD-NEXT:    ucvtf v1.2d, v1.2d
; CHECK-SD-NEXT:    and v4.8b, v4.8b, v3.8b
; CHECK-SD-NEXT:    mov v18.s[1], w11
; CHECK-SD-NEXT:    ucvtf v2.2d, v2.2d
; CHECK-SD-NEXT:    stp q19, q0, [x8, #160]
; CHECK-SD-NEXT:    ucvtf v6.2d, v6.2d
; CHECK-SD-NEXT:    ushll v0.2d, v17.2s, #0
; CHECK-SD-NEXT:    ushll v22.2d, v22.2s, #0
; CHECK-SD-NEXT:    and v17.8b, v23.8b, v3.8b
; CHECK-SD-NEXT:    mov v5.s[1], w9
; CHECK-SD-NEXT:    ushll v4.2d, v4.2s, #0
; CHECK-SD-NEXT:    and v19.8b, v24.8b, v3.8b
; CHECK-SD-NEXT:    ucvtf v0.2d, v0.2d
; CHECK-SD-NEXT:    stp q20, q6, [x8, #128]
; CHECK-SD-NEXT:    ucvtf v22.2d, v22.2d
; CHECK-SD-NEXT:    ushll v6.2d, v17.2s, #0
; CHECK-SD-NEXT:    ucvtf v4.2d, v4.2d
; CHECK-SD-NEXT:    and v17.8b, v18.8b, v3.8b
; CHECK-SD-NEXT:    ushll v18.2d, v19.2s, #0
; CHECK-SD-NEXT:    ucvtf v19.2d, v21.2d
; CHECK-SD-NEXT:    stp q2, q22, [x8, #32]
; CHECK-SD-NEXT:    and v2.8b, v5.8b, v3.8b
; CHECK-SD-NEXT:    ucvtf v3.2d, v6.2d
; CHECK-SD-NEXT:    stp q4, q0, [x8]
; CHECK-SD-NEXT:    ushll v5.2d, v17.2s, #0
; CHECK-SD-NEXT:    ushll v0.2d, v7.2s, #0
; CHECK-SD-NEXT:    ucvtf v6.2d, v18.2d
; CHECK-SD-NEXT:    ucvtf v4.2d, v16.2d
; CHECK-SD-NEXT:    ushll v2.2d, v2.2s, #0
; CHECK-SD-NEXT:    stp q3, q19, [x8, #224]
; CHECK-SD-NEXT:    ucvtf v3.2d, v5.2d
; CHECK-SD-NEXT:    ucvtf v0.2d, v0.2d
; CHECK-SD-NEXT:    stp q4, q6, [x8, #192]
; CHECK-SD-NEXT:    ucvtf v2.2d, v2.2d
; CHECK-SD-NEXT:    stp q3, q1, [x8, #96]
; CHECK-SD-NEXT:    stp q2, q0, [x8, #64]
; CHECK-SD-NEXT:    ret
;
