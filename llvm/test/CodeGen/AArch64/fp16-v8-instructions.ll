...
; CHECK-CVT-NEXT:    mov v16.h[1], w8
; CHECK-CVT-NEXT:    csetm w8, ne
; CHECK-CVT-NEXT:    fcmp s5, s4
; CHECK-CVT-NEXT:    mov h4, v0.h[5]
; CHECK-CVT-NEXT:    mov h5, v0.h[6]
; CHECK-CVT-NEXT:    mov h0, v0.h[7]
; CHECK-CVT-NEXT:    mov v16.h[2], w8
; CHECK-CVT-NEXT:    csetm w8, ne
; CHECK-CVT-NEXT:    fcmp s3, s2
; CHECK-CVT-NEXT:    fcvt s2, h6
...
; CHECK-CVT-NEXT:    mov v16.h[3], w8
; CHECK-CVT-NEXT:    csetm w8, ne
; CHECK-CVT-NEXT:    fcmp s3, s2
; CHECK-CVT-NEXT:    fcvt s2, h4
; CHECK-CVT-NEXT:    fcvt s3, h5
; CHECK-CVT-NEXT:    fcvt s1, h1
; CHECK-CVT-NEXT:    mov v16.h[4], w8
; CHECK-CVT-NEXT:    csetm w8, ne
; CHECK-CVT-NEXT:    fcmp s3, s2
; CHECK-CVT-NEXT:    mov v16.h[5], w8
; CHECK-CVT-NEXT:    csetm w8, ne
; CHECK-CVT-NEXT:    fcmp s0, s1
; CHECK-CVT-NEXT:    mov v16.h[6], w8
; CHECK-CVT-NEXT:    csetm w8, ne
; CHECK-CVT-NEXT:    mov v16.h[7], w8
; CHECK-CVT-NEXT:    xtn v0.8b, v16.8h
; CHECK-CVT-NEXT:    ret
;
...
; CHECK-CVT-NEXT:    mov h4, v0.h[5]
; CHECK-CVT-NEXT:    mov v6.h[2], w8
; CHECK-CVT-NEXT:    csetm w8, eq
; CHECK-CVT-NEXT:    csinv w8, w8, wzr, vc
; CHECK-CVT-NEXT:    fcmp s5, s3
; CHECK-CVT-NEXT:    fcvt s2, h2
; CHECK-CVT-NEXT:    fcvt s3, h4
; CHECK-CVT-NEXT:    mov h4, v1.h[6]
; CHECK-CVT-NEXT:    mov h5, v0.h[6]
; CHECK-CVT-NEXT:    mov v6.h[3], w8
; CHECK-CVT-NEXT:    mov h1, v1.h[7]
; CHECK-CVT-NEXT:    mov h0, v0.h[7]
; CHECK-CVT-NEXT:    csetm w8, eq
; CHECK-CVT-NEXT:    csinv w8, w8, wzr, vc
...
; CHECK-CVT-NEXT:    fcvt s2, h4
; CHECK-CVT-NEXT:    fcvt s3, h5
; CHECK-CVT-NEXT:    mov v6.h[4], w8
; CHECK-CVT-NEXT:    fcvt s1, h1
; CHECK-CVT-NEXT:    fcvt s0, h0
; CHECK-CVT-NEXT:    csetm w8, eq
; CHECK-CVT-NEXT:    csinv w8, w8, wzr, vc
; CHECK-CVT-NEXT:    fcmp s3, s2
; CHECK-CVT-NEXT:    mov v6.h[5], w8
; CHECK-CVT-NEXT:    csetm w8, eq
; CHECK-CVT-NEXT:    csinv w8, w8, wzr, vc
; CHECK-CVT-NEXT:    fcmp s0, s1
; CHECK-CVT-NEXT:    mov v6.h[6], w8
; CHECK-CVT-NEXT:    csetm w8, eq
; CHECK-CVT-NEXT:    csinv w8, w8, wzr, vc
; CHECK-CVT-NEXT:    mov v6.h[7], w8
; CHECK-CVT-NEXT:    xtn v0.8b, v6.8h
; CHECK-CVT-NEXT:    ret
;
