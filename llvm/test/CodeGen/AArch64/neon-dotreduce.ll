...
; CHECK-NEXT:    smull v23.8h, v24.8b, v23.8b
...
; CHECK-NEXT:    ld1 { v2.b }[5], [x8]
; CHECK-NEXT:    add x8, sp, #448
; CHECK-NEXT:    ld1 { v4.b }[4], [x13]
; CHECK-NEXT:    ld1 { v5.b }[4], [x8]
; CHECK-NEXT:    add x11, sp, #120
; CHECK-NEXT:    add x13, sp, #392
